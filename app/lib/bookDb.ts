...
export const BOOK_DB: Record<string, BookDetail> = {
  "1": {
...
AR(증강현실) 기능을 탑재한 초등 파닉스 완성 교재입니다. Single Letters 단계부터 체계적으로 영어 소리와 철자의 관계를 익히며, 생동감 있는 일러스트와 스토리로 흥미롭게 학습합니다.
...
포인트 30개로 중학영어 문법·쓰기를 마스터하는 교재입니다. 문법 포인트를 이해하고, 이를 쓰기와 연결하여 연속으로 타파하는 방식으로 실력을 빠르게 끌어올립니다.
...
어디서나 술술 풀리는 영단어! 수능·내신 필수 어휘를 체계적으로 학습하고, CLASS CARD 앱 연동을 통해 언제 어디서나 효율적으로 암기할 수 있습니다.
...
Reading Prime Series는 6단계로 구성된 중등 독해서입니다. Level 2는 중학교 2학년 수준의 심화 독해로, 논리적 사고력과 독해력을 동시에 키웁니다.
...
2022 개정 교육과정을 완벽 반영한 중등 수학 연산 교재입니다. 연산 반복 학습으로 개념을 확실히 잡아주는 진도북과 추가 훈련을 위한 드릴북으로 구성되어 있습니다.
...
수능대비 독해실력 상승 프로젝트! 53개 핵심구문 포인트를 집중 학습하여 수능 영어 독해 실력을 완성하는 교재입니다.
...
수능영어 1등급 프로젝트. EBS 듣기 교재 집필진이 직접 만든 영어듣기 모의고사 30회 완성 교재입니다. 실제 수능 듣기 유형을 완벽히 재현한 문항으로 실전 감각을 극대화합니다.
